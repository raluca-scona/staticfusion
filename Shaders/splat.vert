...
void main()
{
    ...
    if(vPosHome.z > maxDepth || vPosHome.z < 0.4 || vPosition.w < confThreshold || time - vColor.w > timeDelta || vColor.w > maxTime)
    {
    ...
    else
    {
        ...
        colTime = vColor;
	    position = vec4(vPosHome.xyz, vPosition.w);  //here we are passing on the confidence
