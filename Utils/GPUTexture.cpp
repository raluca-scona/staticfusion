...
const std::string GPUTexture::WEIGHT_VIS = "WEIGHT_VIS";
const std::string GPUTexture::WEIGHT = "WEIGHT";
const std::string GPUTexture::LABELS = "LABELS";
const std::string GPUTexture::DEPTH_PRED = "DEPTH_PRED";
const std::string GPUTexture::WEIGHT_PRED = "WEIGHT_PRED";
